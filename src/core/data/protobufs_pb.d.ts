...
export namespace ApiConfigCreateEntityResponse {
  ...
  // Fix: Initialize the constant StatusEnum
...
export namespace ApiRuntimeDatabaseRequest {
  ...
  // Fix: Initialize the constant RequestTypeEnum
...
export namespace DatabaseRequest {
  ...
  // Fix: Initialize the constant WriteOptEnum
...
export namespace LogMessage {
  ...
  // Fix: Initialize the constant LogLevelEnum

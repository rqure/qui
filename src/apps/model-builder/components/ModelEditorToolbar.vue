...
const tools = [
  {
    id: 'select',
    name: 'Select',
    icon: 'M7,2L7,10L9,8L11,10L17,4L15,2L11,6L9,4L7,2M22,6L19,9L17.5,7.5L14.5,10.5L13,9L10,12L9,11L5,15L7,17L9,15L10,16L13,13L14.5,14.5L17.5,11.5L19,13L22,10L22,6Z'
  },
  {
    id: 'pan',
    name: 'Pan',
    icon: 'M13,6V11H18V7.75L22.25,12L18,16.25V13H13V18H16.25L12,22.25L7.75,18H11V13H6V16.25L1.75,12L6,7.75V11H11V6H7.75L12,1.75L16.25,6H13Z'
  },
  {
    id: 'rect',
    name: 'Rectangle',
    icon: 'M4,6V19H20V6H4Z'
  },
  {
    id: 'circle',
    name: 'Circle',
  ...
  },
  {
    id: 'arrow',
    name: 'Arrow',
    icon: 'M19,6.41L17.59,5L7,15.59V9H5V19H15V17H8.41L19,6.41Z'
  }
];

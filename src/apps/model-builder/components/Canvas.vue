...
import { as2dArray, getCenter, type QBounds, type QPoint } from '@/core/utils/drawing';
import "leaflet/dist/leaflet.css";
import L from 'leaflet';

const bottomLeft = ref<QPoint>({ x: 0, y: 0, z: 0 });
const topRight = ref<QPoint>({ x: 1000, y: 1000, z: 0 });
